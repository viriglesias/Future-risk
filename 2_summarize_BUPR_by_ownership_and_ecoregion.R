...
# Description:
#   Summarizes annual BUPR structure counts within Level IV ecoregions of the
#   conterminous United States by overlaying yearly BUPR rasters with the
#   exclusion raster and aggregating values by ownership / exclusion class.
#   The workflow produces per-ecoregion annual summaries for downstream analysis
#   of structures across federal, state, tribal, local, joint, water, and
#   private lands.
# Inputs:
#   Data/Raw/BUPR/BUPR/; Data/Processed/exclude.tif;
