...
#   compiles a unified table of observed and projected structure counts through
#   time. The workflow attaches ecoregion metadata, assigns broad regional
#   classes, computes 95% confidence intervals, and exports the final structure
#   projection dataset for downstream analysis and mapping.
# Inputs:
